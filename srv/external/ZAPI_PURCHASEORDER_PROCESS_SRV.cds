/* checksum : 6f37cd9d582f8d79696b5578e118f681 */
@cds.external : true
...
service ZAPI_PURCHASEORDER_PROCESS_SRV {
  ...
  entity A_POSubcontractingComponent {
    ...
    @sap.label : 'Label ID'
    LabelID : String(60);
    @sap.label : 'Expiry Date Rel.'
    @sap.quickinfo : 'Expiry Date Relevant'
    UBDRelevant : Boolean;
    @sap.label : 'Barcode Relevant'
    BarcodeRelevant : Boolean;
    @sap.display.format : 'UpperCase'
    ...
    CompStorageLocation : String(4);
    @sap.label : 'No. of Ret. Samples'
    @sap.quickinfo : 'Retention Quantity'
    RetentionQty : Integer;
    @sap.display.format : 'UpperCase'
    @sap.label : 'GTIN'
    @sap.quickinfo : 'Global Trade Item Number (EAN/UPC/GTIN)'
    GTIN : String(18);
    @sap.label : 'Print Location'
    LabelPrintingLoc : String(10);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Print Supplier'
    LabelPrintingVendor : String(10);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Reference Material'
    ReferenceMaterial : String(40);
  };
  ...
  entity A_PurchaseOrder {
    ...
    to_PurchaseOrderNote : Composition of many A_PurchaseOrderNote {  };
  } actions {
    function GetOutputBinaryData() returns GetPDFResult;
    function GetPDF() returns GetPDFResult;
  };
  ...
  entity A_PurchaseOrderItem {
    ...
    ExpiryDate : String(8);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Blinding Group ID'
    BlindingGroupID : String(30);
    @sap.label : 'Serialized'
    @sap.quickinfo : 'Serialized (True/False value - True: Serialized)'
    Serialized : Boolean;
    @sap.label : 'Safety Stock'
    SafetyStock : Decimal(13, 3);
    DepotCounter : String(3);
    PcnDepot : String(14);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Study'
    StudyId : String(10);
    ...
    @sap.label : 'Pool ID'
    PoolId : String(10);
    @sap.label : 'Pool Description'
    PoolDescription : String(200);
    @sap.label : 'Study Protocol IDs'
    ProtocolId : String(1000);
    @sap.display.format : 'UpperCase'
    @sap.label : 'EAN/UPC'
    @sap.quickinfo : 'International Article Number (EAN/UPC)'
    GTIN : String(18);
    ...
    @sap.field.control : 'ZZ1_PercentageCompleti_PDIF'
    @sap.label : 'Percentage Completion'
    @sap.is.extension.field : 'true'
    ZZ1_PercentageCompleti_PDI : Decimal(5, 2);
    @sap.field.control : 'ZZ1_ACTestFieldSTO_PDIF'
    @sap.label : 'AC Test Field'
    @sap.is.extension.field : 'true'
    ZZ1_ACTestFieldSTO_PDI : String(20);
    @odata.Type : 'Edm.Byte'
    @sap.visible : 'false'
    ...
    @sap.is.extension.field : 'true'
    ZZ1_ACTestFieldSTO_PDIF : Integer;
    @odata.Type : 'Edm.Byte'
    @sap.visible : 'false'
    @sap.label : 'UI Field Control'
    @sap.creatable : 'false'
    ...
    @sap.filterable : 'false'
    @sap.is.extension.field : 'true'
    ZZ1_PercentageCompleti_PDIF : Integer;
    to_PurchaseOrder : Association to A_PurchaseOrder {  };
    to_AccountAssignment : Composition of many A_PurOrdAccountAssignment {  };
    to_PurchaseOrderItemNote : Composition of many A_PurchaseOrderItemNote {  };
    to_PurchaseOrderPricingElement : Composition of many A_PurOrdPricingElement {  };
    to_ScheduleLine : Composition of many A_PurchaseOrderScheduleLine {  };
    to_PurchaseItemMedNo : Association to many A_PurchaseOrderItemMedNo {  };
    to_PurchaseItemCFGBarcode : Association to many A_PurchaseOrderItemCFGBarcode {  };
    to_PurchaseItemLabelBarcode : Association to many A_PurchaseOrderItemLabelBarcode {  };
  };
  ...
  entity A_PurchaseOrderItemNote {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Purchasing Document'
  ...
  entity A_PurchaseOrderScheduleLine {
    ...
    CfgVendorBatch : String(15);
    to_SubcontractingComponent : Composition of many A_POSubcontractingComponent {  };
  };
  ...
  @sap.content.version : '1'
  entity A_PurchaseOrderItemMedNo {
    @sap.quickinfo : 'Medication Number Set'
    @sap.label : 'Number Set'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    key SetNo : String(8) not null;
    @sap.quickinfo : 'Medication Number'
    @sap.label : 'MedNum'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    key MedNo : String(40) not null;
    @sap.quickinfo : 'Sequence Number'
    ...
    @sap.quickinfo : 'Purchase Order Item'
    @sap.label : 'Item'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
  ...
  @sap.addressable : 'false'
  @sap.content.version : '1'
  entity A_PurchaseOrderItemCFGBarcode {
    @sap.quickinfo : 'Purchase Order'
    @sap.label : 'Purchasing Doc.'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.filterable : 'false'
    key MedNo : String(40) not null;
    @sap.quickinfo : 'CFG Barcode'
    @sap.label : 'Bar Code'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    CFGBarcode : String(255) not null;
    @sap.quickinfo : 'CFG Label ID'
    @sap.label : 'Label ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    CFGLabelId : String(60) not null;
    to_PurchaseItemPPBarcode : Association to many A_PurchaseOrderItemPPBarcode {  };
  };
  ...
  @sap.addressable : 'false'
  @sap.content.version : '1'
  entity A_PurchaseOrderItemPPBarcode {
    @sap.quickinfo : 'Purchase Order'
    @sap.label : 'Purchasing Doc.'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    ITIP : String(18) not null;
    @sap.quickinfo : 'PP Label ID'
    @sap.label : 'Label ID'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    PPLabelId : String(60) not null;
    @sap.quickinfo : 'PP Barcode'
    @sap.label : 'Bar Code'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    PPBarcode : String(255) not null;
  };
  ...
  @sap.addressable : 'false'
  @sap.content.version : '1'
  entity A_PurchaseOrderItemLabelBarcode {
    @sap.quickinfo : 'Purchase Order'
    @sap.label : 'Purchasing Doc.'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.quickinfo : 'Barcode Type'
    @sap.label : 'Barcode Type'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    @sap.sortable : 'false'
    @sap.filterable : 'false'
    BarcodeType : String(1) not null;
  };
